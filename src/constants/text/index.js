...
export const REJECTED_COURSES = 'Rejected Courses'
...
export const REJECT_WITHDRAWAL = 'Reject Withrdrawal Request'
export const WITHDRAWAL_MGT = 'Withdrawal Management'
